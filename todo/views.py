...
def create_todo(request):
    ...
    if request.method == 'POST':
        ...
        messages.add_message(request, messages.SUCCESS, 'Задача была создана')
...
def todo_delete(request, id):
    ...
    if request.method == 'POST':
        ...
        if todo.owner == request.user:
            todo.delete()
            messages.add_message(request, messages.WARNING, 'Задача была удалена')
...
def todo_edit(request, id):
    ...
    if request.method == 'POST':
        ...
        messages.add_message(request, messages.SUCCESS, 'Задача была отредактирована')
